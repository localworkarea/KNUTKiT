...
***************************************************************************** */
    ...
    function customizePaginationBullets(swiper) {
        ...
        if (bullets[activeIndex - 1]) bullets[activeIndex - 1].classList.add("swiper-pagination-bullet-before");
        if (bullets[activeIndex + 1]) bullets[activeIndex + 1].classList.add("swiper-pagination-bullet-after");
    }
    function initSliders() {
        ...
        if (document.querySelector(".home-msg__slider")) new Swiper(".home-msg__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 20,
        ...
        if (document.querySelector(".home-ad__slider")) new Swiper(".home-ad__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 20,
        ...
        if (document.querySelector(".photo__slider")) {
            ...
            const swiper = new Swiper(".photo__slider", {
                ...
                on: {
                    init: function() {
                        const lg = lightgallery_es5(lgSwiper, {
        ...
        if (document.querySelector(".video-glr__slider")) new Swiper(".video-glr__slider", {
            modules: [ Navigation, Pagination, EffectCoverflow ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        if (window.innerWidth >= 75.061 * parseFloat(getComputedStyle(document.documentElement).fontSize)) document.addEventListener("click", handleOutsideMenuClick);
            ...
            menuItemsWithChildren.forEach((item => {
                ...
                if (link) link.addEventListener("click", (function(event) {
                    ...
                    if (window.innerWidth < 75.061 * parseFloat(getComputedStyle(document.documentElement).fontSize)) {
                        ...
                        if (currentOpenItem && currentOpenItem !== parentMenuItem) currentOpenItem.classList.remove("_open");
